...
import { PaymentWorkspaceComponent } from './features/payment/pages/payment-workspace/payment-workspace.component';
...
export const routes: Routes = [
	...
	{ path: 'reset-password', component: AuthPageComponent, data: { mode: 'reset-password' }, title: 'Set password | SureCover' },
	{
		...
		children: [
			{ path: 'dashboard', component: DashboardComponent, canActivate: [authGuard], data: { roles: ['PlatformAdmin', 'KycReviewer', 'PolicyUnderwriter', 'ClaimsAdjuster', 'PaymentOperations', 'SupportAgent'] }, title: 'Dashboard | SureCover' },
			{ path: 'customer/dashboard', component: DashboardComponent, canActivate: [authGuard], data: { roles: ['Customer'] }, title: 'Dashboard | SureCover' },
			...
			{ path: 'customer/insurance-products', component: PolicyWorkspaceComponent, canActivate: [authGuard], data: { roles: ['Customer'] }, title: 'Insurance Products | SureCover' },
			{ path: 'customer/applications', component: PolicyWorkspaceComponent, canActivate: [authGuard], data: { roles: ['Customer'] }, title: 'My Applications | SureCover' },
			{ path: 'customer/policies', component: PolicyWorkspaceComponent, canActivate: [authGuard], data: { roles: ['Customer'] }, title: 'My Policies | SureCover' },
			{ path: 'customer/payments', component: PaymentWorkspaceComponent, canActivate: [authGuard], data: { roles: ['Customer'] }, title: 'Payments | SureCover' },
			...
			{ path: 'customer/claims', component: ClaimsListComponent, canActivate: [authGuard], data: { roles: ['Customer'] }, title: 'My Claims | SureCover' },
			...
			{ path: 'underwriter/dashboard', component: DashboardComponent, canActivate: [authGuard], data: { roles: ['PolicyUnderwriter'] }, title: 'Underwriting Dashboard | SureCover' },
			...
			{ path: 'claims-adjuster/dashboard', component: DashboardComponent, canActivate: [authGuard], data: { roles: ['ClaimsAdjuster'] }, title: 'Claims Dashboard | SureCover' },
			{ path: 'claims-adjuster/claims', component: ClaimsListComponent, canActivate: [authGuard], data: { roles: ['ClaimsAdjuster'] }, title: 'Claims Queue | SureCover' },
			...
			{ path: 'payments', component: PaymentWorkspaceComponent, canActivate: [authGuard], data: { roles: ['Customer'] }, title: 'Payments | SureCover' },
			...
			{ path: 'claims', component: ClaimsListComponent, canActivate: [authGuard], data: { roles: ['Customer', 'ClaimsAdjuster', 'SupportAgent'] }, title: 'Claims | SureCover' },
	...
	{ path: 'compliance/assistant', redirectTo: 'ai-assistant', pathMatch: 'full' },
	{
		path: 'ai-assistant',
		canActivate: [authGuard],
		data: { roles: ['Customer', 'PolicyUnderwriter', 'ClaimsAdjuster', 'ComplianceOfficer', 'PlatformAdmin'] },
